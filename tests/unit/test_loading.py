...
class TestLoadingFunctions(unittest.TestCase):
    ...
    def test_filter_files(self):
        ...
        self.assertEqual(
            basic_filter,
            ["neptune_01.fits", "neptune_04.fits", "toi3884_0001.fits", "toi3884_0002.fits", "toi3884_0003.fits"]
        )
        self.assertEqual(
            toi3884_filter,
            ["toi3884_0001.fits", "toi3884_0002.fits"]
        )
        self.assertEqual(
            neptune_filter,
            ["neptune_01.fits", "neptune_04.fits"]
        )
        self.assertEqual(
            bad_filter,
            []
